...
import problems.cricbuzz.team.player.Person;
import problems.cricbuzz.team.player.Player;
import problems.cricbuzz.team.player.PlayerType;
import problems.cricbuzz.type.MatchType;
import problems.cricbuzz.type.T20Match;
...
public class Main {
    ...
    private Team addTeam(String name) {
        ...
        return new Team(name, Player, new ArrayList<>(), bowlers);
    }
